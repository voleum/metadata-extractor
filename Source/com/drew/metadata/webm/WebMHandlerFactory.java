...
public class WebMHandlerFactory
{
    ...
    private WebMHandler<?> caller;

    public WebMHandlerFactory(WebMHandler<?> caller)
    {
        this.caller = caller;
    }

    public WebMHandler<?> getHandler(HandlerBox box, Metadata metadata, Mp4Context context)
    {
